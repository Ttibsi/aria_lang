...
[[maybe_unused]] static void* bufferGet(const Aria_Buffer* buf, uint32_t idx);
[[maybe_unused]] static void* bufferPeek(const Aria_Buffer* buf);
[[maybe_unused]] static void bufferCopy(Aria_Buffer* dst, const Aria_Buffer* src);
